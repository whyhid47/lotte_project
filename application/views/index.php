...
<html>
   ...
   <body>
      ...
      <main>
         <div class="toko">
            <h2><a href="<?= base_url(); ?>"><i class="fa fa-shopping-cart"></i> Ready To Eat</a></h2>
         ...
         <div class="cont">
            ...
            <footer class="page-footer cyan darken-1">
               <div class="container">
                  <div class="row">
                     <div class="col l6 s12">
                        ...
                        <p class="grey-text text-lighten-4">Jl. Jend. A. Yani Kav 49 <br /><i class="fa fa-phone-square"></i> 089654472617</p>
                     </div>
                     <div class="col l5 offset-l1 s12">
                        <h5 class="white-text">Follow kami</h5>
                        <div class="link">
                           ...
                           <a class="grey-text text-lighten-3" href="https://www.instagram.com/lottemartpramuka/?hl=id"><i class="fa fa-instagram"></i> Instagram</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="footer-copyright">
                  <div class="container">
                     Copyright © 2018 RTE. All Rights Reserved.
                     <span class="grey-text text-lighten-4 right">designed By <a class="blue-text text-lighten-4" href="#!">ALC Pramuka</a></span>
                  </div>
               </div>
            </footer>
         </div>
